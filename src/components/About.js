  ...
  return (
    <>
      <div className='min-h-screen flex justify-center  xl:items-center'>
        <div className='sm:place-self-center w-8/12 content-center  mt-10 sm:mt-20 xl:w-6/12 flex items-center  flex-col xl:flex-row xl:flex-none  '>
          ...
          <img
            className='w-64 h-64 rounded-full border-8  border-white  mb-10 md:ml-4 lg:mt-7 order-first xl:order-last'
            src={nurseliImg}
            alt=''
          />
        </div>
